...
public class mostrarCustomUpper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mostrar_custom_upper);
        ...
        tvnombre.setText(" Inserte Ejercicio Upper");
        etrepe1.setText("1");
        etrepe2.setText("1");
        etrepe3.setText("1");
