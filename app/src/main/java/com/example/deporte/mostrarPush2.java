...
public class mostrarPush2 extends AppCompatActivity {

    public EditText tvnombre, etrepe1, etpeso1, etrepe2, etpeso2, etrepe3, etpeso3;
    public TextView tvfechas;

    String[] EjerPush = {"PRESS MILITAR c/m", "Press Banca 15º c/m", "Press Banca 30º c/m", "Aperturas 15º", "Elevación Frontal", "Elevación Lateral", "Dips", "Extensión cuerda"};
    int i = 0;

    String[] RepesPush1 = {"8","10", "15", "12", "15", "15", "20", "10"};
    int j = 0;

    String[] RepesPush2 = {"6", "10", "12", "12", "12", "15", "15", "10"};
    int k = 0;

    String[] RepesPush3 = {"6", "8", "10", "10", "10", "15", "15", "8"};
    int l = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mostrar_push2);
